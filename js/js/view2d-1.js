    ...
    var ar = {
        ...
        setArData: function () {
            ...
            for (var idx = 0; idx < self.C.arNum; idx=(idx+1)|0) {
                ...
                //var gazou = self.arg['p' + idx].path;

                //window.confirm($('[p' + idx+ '=url]').val());

                //fsize = sgazou.fileSize;

                //if (self.arg['p' + idx] == null) {
                //    window.confirm($('画像なし').val());
                //    flg = false;
                //}
                ...
                //window.confirm(dataObj.isMarker);
                ...
                dataObj.isGif = !!(self.arg['p' + idx] || '').match(/\.gif$/i);
        ...
        setSwitcher: function () {
            ...
            var swInfo = document.getElementById('swInfo');

            var infoContent = document.getElementById('infoContent');

            swInfo.addEventListener('click', function() {
                infoContent.classList.toggle('show');
                swInfo.classList.toggle('current');
            });
        ...
        setScene: function () {
            ...
            if (self.arg.multi) {
                if (self.arg.preview) {
                    ...
                    for (var idx = 0; idx < self.C.arNum; idx = (idx + 1) | 0) {
                        ...
                        if (!!self.arData[idx].mk) {
                            arMarker.setAttribute('url', 'pattern/pattern-' + self.arData[idx].mk + '.patt');
                        } else {
                            arMarker.setAttribute('url', 'pattern/pattern-' + idx + '.patt');
                        }
                        ...
                        window.confirm(arMarker.getAttribute(url));
            ...
            if (location.pathname.match(/vr/)) {
                ...
                if (!!self.arg.mk) {
                    mWrap.setAttribute('url', 'pattern/pattern-' + self.arg.mk + '.patt');
                } else {
