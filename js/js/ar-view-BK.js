        ...
        createModel : function() {
            ...
            for (var idx = 0; idx < self.C.arNum; idx=(idx+1)|0) {
                ...
                if (idx && val.isShadow) {
                    ...
                    var ppp = self.positionVec3(idx, 'shadow');
                    window.alert('x:' + String(ppp.x) + ' y:' + String(ppp.y) + ' z:' + String(ppp.z));
                ...
                window.alert('x:' + String(posVec3.x) + ' y:' + String(posVec3.y) + ' z:' + String(posVec3.z));
                ...
                if (self.arg.preview) {
                    ...
                    for (var idx = 0; idx < self.C.arNum; idx = (idx + 1) | 0) {
                        ...
                        if (!!self.arData[idx].m) {
                            arMarker.setAttribute('url', 'pattern/pattern-' + self.arData[idx].m + '.patt');
                        } else {
