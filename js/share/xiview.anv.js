    ...
    var ar = {
                    ...
                    if (!!(args[idx].FireWorkList)) {
                        ...
                        if (fsize != -1) {
                            ...
                            for (var k = 0; k < fw.length; k++) {
                                ...
                                attribute.attribute = fw[k].attribute;
                                attribute.color = fw[k].color;
        ...
        startFireworksEvent: function (oidx) {
            ...
            for (var i = 0; i < webAr.ar.args[oidx].Particlefireworks.length; i++) {
                ...
                var pf = document.querySelector('#bFirework' + (i + 1).toString());

                if (pf == null) {
                    pf = document.createElement('a-entity');
                    pf.setAttribute('id', 'bFirework' + (i + 1).toString());
                    pf.setAttribute('class', 'bSpawner');

                    var scene = document.querySelector('a-scene');
                    scene.appendChild(pf);
                }
        ...
        removeFireworks: function () {
            ...
            let f = document.querySelectorAll('.bSpawner');
        ...
        readFireworksXml: function (filenm) {
            ...
            function setXmldata(xmldata) {
                ...
                var cColor = xmldata.getElementsByTagName("color");
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    data[i] = {
                        ...
                        color: (cColor[i] != null) && cColor[i].textContent,
                        ...
                        bOpacity: (bOpacity[i] != null) && bOpacity[i].textContent,
                        tOpacity: (tOpacity[i] != null) && tOpacity[i].textContent,
                        frequency: (frequency[i] != null) && frequency[i].textContent,
